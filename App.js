    ...
    return(
        <div className="restaurant-card">
            <div className="card-img">
                <img src={"https://media-assets.swiggy.com/swiggy/image/upload/"+cloudinaryImageId} alt="image not loading"></img>
            </div>
            <h2>{name}</h2>
            <p>{avgRating}</p>
            <p>{cuisines.join(", ")}</p>
...
const restList = [
    
    {
      ...
      "analytics": {
        "context": "seo-data-5dea8d94-b906-4687-8070-8f879cf4ca53"
      },
      "cta": {
    ...
    },
    {
      ...
      "cta": {
        "link": "https://www.swiggy.com/city/bangalore/itc-aashirvaad-soul-creations-kalyan-nagar-dodda-banaswadi-rest678080",
        "text": "RESTAURANT_MENU",
        "type": "WEBLINK"
      },
      "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
    },
    {
      ...
      "cta": {
        "link": "https://www.swiggy.com/city/bangalore/five-star-chicken-kanakanagar-r-t-nagar-rest174211",
        "text": "RESTAURANT_MENU",
        "type": "WEBLINK"
      },
      "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
    },
    {
      "info": {
        ...
        "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2024/8/26/1cab5187-fac1-4adb-8ad4-25cfa4cc02c9_129540.jpg",
        "locality": "Kalyan Nagar",
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2024-09-04 01:30:00",
          "opened": true
        },
        "badges": {
          "imageBadges": [
      ...
      "cta": {
        "link": "https://www.swiggy.com/city/bangalore/meghana-foods-hrbr-layout-kalyan-nagar-rest90018",
        "text": "RESTAURANT_MENU",
        "type": "WEBLINK"
      },
      "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
    },
    {
      ...
      "cta": {
        "link": "https://www.swiggy.com/city/bangalore/olio-the-wood-fired-pizzeria-dodda-banaswadi-main-rd-hennur-rest736185",
        "text": "RESTAURANT_MENU",
        "type": "WEBLINK"
      },
      "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
        ...
        <div className="body">
            ...
            <div className="restaurant-container">
                {restList.map(restObj =>{
                    return <RestaurantCard restData={restObj}/>
                })}
            </div>
        </div>
    );
